  ...
  def render(assigns) do
    ...
    <nav>
      <ul class="lg:flex items-center justify-between text-base text-gray-700 pt-4 lg:pt-0">
        <li><%= live_patch to: Routes.todo_list_index_path(@socket, :index) do %><div class="lg:p-4 py-3 px-0 block border-b-2 border-transparent hover:border-indigo-400">Todo List</div><% end %></li>
